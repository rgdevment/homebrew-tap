class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.6.0/tisty-cli-0.6.0-macos-universal.tar.gz"
    sha256 "d105702bcbe6cffa75cf7ad8923df2836d3e32628873db018d310abaec7b0b43"
  end
