class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.8.2/tisty-cli-1.8.2-macos-universal.tar.gz"
    sha256 "83337aed0145e7cfcd4a103559646baf88ccd0e597b0ec42fb921cf34589e0ca"
  end
