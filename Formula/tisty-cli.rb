class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.13.2/tisty-cli-1.13.2-macos-universal.tar.gz"
    sha256 "467892ebd569b32cf41f33793f3c2377aba125d2475767e322bc181996a602f2"
  end
