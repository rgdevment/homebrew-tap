class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.0.6/tisty-cli-1.0.6-macos-universal.tar.gz"
    sha256 "c31b3f24df1b946322b9328fdfb90fe96a6beec7ec0980bf9ffcc226c5e9bf24"
  end
