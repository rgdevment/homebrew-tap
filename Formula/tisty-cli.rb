class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.12.3/tisty-cli-0.12.3-macos-universal.tar.gz"
    sha256 "4f1c1157338289020b6a177879ac42d30ac1d17429db6d6eaea2e1525a216cab"
  end
