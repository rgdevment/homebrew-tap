class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.4.0/tisty-cli-0.4.0-macos-universal.tar.gz"
    sha256 "fa38fc1e96602a5d68f15e217d3ea05d01ab2e7cfe18b33147201e5a66a065af"
  end
