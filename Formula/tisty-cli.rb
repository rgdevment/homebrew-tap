class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.14.0/tisty-cli-1.14.0-macos-universal.tar.gz"
    sha256 "d864c73146bc8ad47190fceeb7dd7bdf3365b7ff19c111bdde73fed74771495a"
  end
