class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.7.1/tisty-cli-0.7.1-macos-universal.tar.gz"
    sha256 "20dcfcc60ad796f9bdbc57f6caab96959b0966a127f0a41cddee43629715dd96"
  end
