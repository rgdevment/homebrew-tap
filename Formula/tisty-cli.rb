class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.11.1/tisty-cli-0.11.1-macos-universal.tar.gz"
    sha256 "e42232685768f776bf6141fda115a468a2c9460265444fd4cd18922f23d5c4a9"
  end
