class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.8.1/tisty-cli-0.8.1-macos-universal.tar.gz"
    sha256 "29280309968d55c2493ab209aa2edee74c6bddd04b33637ef8ceb2ee44955079"
  end
