class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.12.0/tisty-cli-0.12.0-macos-universal.tar.gz"
    sha256 "569946616ab7360049e5b19f36b28aab5b123e4091baa2e8ba0d3fcbb5846bce"
  end
