class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.13.1/tisty-cli-1.13.1-macos-universal.tar.gz"
    sha256 "5c83a1c46f183387d12da46ba5876d7a20405eb4cc699e1e0d40bd0daddf99a3"
  end
