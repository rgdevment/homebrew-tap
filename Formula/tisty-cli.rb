class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.12.0/tisty-cli-1.12.0-macos-universal.tar.gz"
    sha256 "0e1ea3101a5035fa30aff53c75e3afefddf20c56daaf71425732565ea29405d7"
  end
