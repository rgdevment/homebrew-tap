class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.0.5/tisty-cli-1.0.5-macos-universal.tar.gz"
    sha256 "f2ca7feb093865df23bd03f3380d6997fbae10436bde86b0c7f9b3639cfb63fd"
  end
