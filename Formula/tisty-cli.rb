class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.0.0/tisty-cli-1.0.0-macos-universal.tar.gz"
    sha256 "f8f5871ec1083f728aef0c1c4753b61255b815503319fbadd24ffdc94219e01e"
  end
