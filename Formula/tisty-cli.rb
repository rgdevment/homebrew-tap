class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.9.0/tisty-cli-1.9.0-macos-universal.tar.gz"
    sha256 "43f155aa76fdef8c4515bb9f93ba68930807fbfc43c71a82b772cab048e7e034"
  end
