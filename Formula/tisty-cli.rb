class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.2.0/tisty-cli-1.2.0-macos-universal.tar.gz"
    sha256 "15c08aa78bbab16a9f2c09ac68e7a162878868dd5742184a0bc72303f67d4666"
  end
