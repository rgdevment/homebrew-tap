class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.10.1/tisty-cli-1.10.1-macos-universal.tar.gz"
    sha256 "e18a634515a656709465deb425130ef8aa4e7d0a62aecdc2b15ac2eb4ca785ab"
  end
