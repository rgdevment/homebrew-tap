class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.4.1/tisty-cli-1.4.1-macos-universal.tar.gz"
    sha256 "0e66ef6ad291d524871fdcd6b639ddba9f8674c6f3f27381941e5c26555ba9fe"
  end
