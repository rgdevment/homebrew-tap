class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.9.3/tisty-cli-1.9.3-macos-universal.tar.gz"
    sha256 "c89d7754a1b7cd911d9e9d43bf3b3ac99c7cc064ccc4f12a5815b05897bcd33d"
  end
