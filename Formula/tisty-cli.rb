class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.3.0/tisty-cli-1.3.0-macos-universal.tar.gz"
    sha256 "39155a7f9110c83e9804d78d6cd481ec435819dc2f9717094821092f1b446dda"
  end
