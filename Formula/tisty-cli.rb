class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v1.8.1/tisty-cli-1.8.1-macos-universal.tar.gz"
    sha256 "bb792740a0ab7bbf314313a8716cd6f1b7656fba680fd7fdc7a13ab306d062ce"
  end
