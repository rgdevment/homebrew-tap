class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.5.0/tisty-cli-0.5.0-macos-universal.tar.gz"
    sha256 "da2e60cc9673b21d138adda63ad1ea8cefaae4986951e8bdaa73c6b1ee48e76f"
  end
