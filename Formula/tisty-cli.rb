class TistyCli < Formula
  ...
  on_macos do
    url "https://github.com/rgdevment/Tisty/releases/download/v0.12.1/tisty-cli-0.12.1-macos-universal.tar.gz"
    sha256 "246a4d849c0e3f90ccd206c3db1f95bfbfbeb77ad709573711296fb29f745725"
  end
