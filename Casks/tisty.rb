cask "tisty" do
  version "1.6.1"
  sha256 "cd691b9a9eedd1853db2c77cfa2e729d9077ab231dcd6e9eb5fba0a590d3b64c"

  url "https://github.com/rgdevment/Tisty/releases/download/v1.6.1/tisty-installer-1.6.1-macos-universal.dmg"
  name "Tisty"
